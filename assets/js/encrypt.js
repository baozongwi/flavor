(function() {
  ...
  // Build an unnumbered nested TOC from decrypted headings.
  // Encrypted stubs have no body, so Hugo's .TableOfContents is empty
  // until this runs on the injected article.
  ...
  // Fill the right-hand sheet. Drop the directory if the body has no headings.
